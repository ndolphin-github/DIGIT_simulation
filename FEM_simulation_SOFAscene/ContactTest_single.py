...
sensor_stl_mesh = os.path.join(mesh_dir, "DIGIT.STL")
sensor_vtk_mesh = os.path.join(mesh_dir, "DIGIT.vtk")
sensor_body_stl_mesh = os.path.join(mesh_dir, "DIGIT_body.STL")
indenter_stl_mesh = os.path.join(mesh_dir, "Indenter/round.STL")
